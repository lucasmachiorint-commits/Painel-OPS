...
// We will find the boundaries of renderCadastrosView
const startToken = 'function renderCadastrosView() {';
const startIdx = content.indexOf(startToken);

// Find the end of the function (which is before function updateBulkDeleteState())
const endToken = '// Update bulk delete button state helper';
...
const newFunction = `function renderCadastrosView() {
...
fs.writeFileSync(file, before + newFunction + after);
