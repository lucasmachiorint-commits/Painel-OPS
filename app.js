...
function recalcSizing(fromInputs = true) {
    ...
    if (fromInputs) {
        ...
        // QUADRO 2: CHAT
        p.volumeMensalChat = Math.max(0, getNum('input-sizing-vol-chat', p.volumeMensalChat || 0));
        ...
        p.telasSimultaneas = Math.max(0.1, getNum('input-sizing-telas-chat', p.telasSimultaneas || 2.0));
